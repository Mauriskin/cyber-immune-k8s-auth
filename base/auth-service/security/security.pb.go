...
const file_security_proto_rawDesc = "" +
	"\n" +
	"\x0esecurity.proto\x12\bsecurity\"\xeb\x01\n" +
	"\fCheckRequest\x12#\n" +
	...
	"\acontext\x18\x04 \x03(\v2#.security.CheckRequest.ContextEntryR\acontext\x1a:\n" +
...
var file_security_proto_goTypes = []any{
	...
	nil,                   // 2: security.CheckRequest.ContextEntry
}
var file_security_proto_depIdxs = []int32{
	2, // 0: security.CheckRequest.context:type_name -> security.CheckRequest.ContextEntry
	0, // 1: security.SecurityController.CheckInteraction:input_type -> security.CheckRequest
	1, // 2: security.SecurityController.CheckInteraction:output_type -> security.CheckResponse
